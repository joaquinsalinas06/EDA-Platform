...
altura `0`, grado de la raíz `0`, y a profundidad `0` hay `C(0,0) = 1` nodo.
...
| nodos a profundidad 0 | `C(2,0) = 1` | sólo `r₁` |
| nodos a profundidad 1 | `C(2,1) = 2` | `r₂` y `h₁` |
| nodos a profundidad 2 | `C(2,2) = 1` | sólo `h₂` |
...
(por ejemplo, dejaría de tener exactamente `C(k,i)` nodos por profundidad
