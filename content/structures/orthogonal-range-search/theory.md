...
Se tienen n puntos en R^d. El profesor plantea el problema así: "Dados n
puntos en R^d, se nos pedirá realizar consultas sobre cajas; es decir, se
nos darán d intervalos [l1,r1], [l2,r2], ..., [ld,rd] y obtendremos
información de los puntos en [l1,r1] × [l2,r2] × ... × [ld,rd]." A ese
...
- Ordenar los n puntos por su única coordenada: `O(n log n)` de
  preprocesamiento.
- Una consulta `[l1, r1]` se resuelve ubicando la frontera del rango con
